...
using Application_Name.Models;

namespace Application_Name.Controllers
{
    public class registrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstName,lastName,nid,course_id,batch_id,tel")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstName,lastName,nid,course_id,batch_id,tel")] registration registration)
        {
            if (ModelState.IsValid)
            {
